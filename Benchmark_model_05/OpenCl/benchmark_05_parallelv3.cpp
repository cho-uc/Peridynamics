...
Serialized all kernels that are slower in GPU
	...
	-u_reinitialization 
Do not write to CPU for each time step

Serial result : 9340 ms (10,000 nodes) 
Parallel result : 7223 ms
Parallel result with partial serialized: 6712 ms
...
int main(int argc, char **argv){
	...
	cout << "Parallel execution (without writing for each time step) = "<<duration_parallel.count()<<" millisecond"<<endl;
