...
float critical_time_step_parallel(size_t *buffer_neighbor_list_pointer,
		...
		const size_t * node, const float* ro, dim3 gridSize, dim3 blockSize){
	...
	critical_time_step<<<gridSize, blockSize>>>(buffer_neighbor_list_pointer,
...
__global__ void u_reinitialization_BC (float *u_dot_x_n0,
	 float *u_dot_y_n0,
	 float *u_dot_z_n0,
	 float *u_doubledot_x_n0,
	 float *u_doubledot_y_n0,
...
//fail because the size of args > 256 byte
...
__global__ void cal_dilatation_pforce (	 
	//for dilatation calculation :
	float *u_x_n1,
	 float *u_y_n1,
	 float *u_z_n1,
...
//fail because the size of args > 256 byte
__global__ void cal_dilatation_pforce_disp (	 
	//for dilatation calculation :
	float *u_x_n1,
	 float *u_y_n1,
	 float *u_z_n1,
